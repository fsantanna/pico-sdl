...
int main (void) {
    ...
    puts("rect at 30%");
    pico_output_clear();
    Pico_Rel_Rect r1 = { '!', {30-25, 30-25, 50, 50}, PICO_ANCHOR_NW };
    ...
    Pico_Rel_Rect r2 = { '!', {r1.x+r1.w/2-12, r1.y+r1.h/2-12, 25, 25}, PICO_ANCHOR_NW };
    ...
    Pico_Rel_Pos p3 = { '!', {r1.x+r1.w/2, r1.y+r1.h/2}, PICO_ANCHOR_NW };
    pico_set_pencil_color(NULL, (Pico_Color){0x00,0x00,0xFF, 0xFF});
    pico_output_draw_pixel(&p3);
    _pico_check("clip-04"); // same as pct

    puts("yellow clipped under gray bottom right");
    Pico_Rel_Rect r4 = { '!', {r1.x+r1.w-12, r1.y+r1.h-12, 25, 25}, PICO_ANCHOR_NW };
