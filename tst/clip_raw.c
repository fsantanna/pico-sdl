...
int main (void) {
    ...
    Pico_Pos p3 = { '!', {r1.x+r1.w/2, r1.y+r1.h/2}, PICO_ANCHOR_NW, NULL };
    ...
    Pico_Rect r4 = { '!', {r1.x+r1.w-12, r1.y+r1.h-12, 25, 25}, PICO_ANCHOR_NW, NULL };
