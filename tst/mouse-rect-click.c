...
int main (void) {
    ...
    pico_output_draw_rect("A", &btn1);
    pico_output_draw_rect("A", &btn2);
    pico_output_draw_rect("A", &btn3);
    ...
    puts("no collision (394,355)");
    {
        ...
        assert(!pico_vs_pos_rect("root", &pos, &btn1));
        assert(!pico_vs_pos_rect("root", &pos, &btn2));
        assert(!pico_vs_pos_rect("root", &pos, &btn3));
        pico_set_pencil_color("root", PICO_COLOR_RED);
        pico_output_draw_pixel("root", &(Pico_Rel_Pos){ 'w', {394, 355}, PICO_ANCHOR_C, NULL });
    ...
    puts("click 3 (457,431)");
    {
        ...
        pico_output_draw_pixel("root", &(Pico_Rel_Pos){ 'w', {457, 431}, PICO_ANCHOR_C, NULL });
    ...
    puts("click 1 (362,405)");
    {
        ...
        assert(!pico_vs_pos_rect("root", &pos, &btn3));
        pico_set_pencil_color("root", PICO_COLOR_GREEN);
        pico_output_draw_pixel("root", &(Pico_Rel_Pos){ 'w', {362, 405}, PICO_ANCHOR_C, NULL });
    ...
    puts("click 2 (415,392)");
    {
        ...
        assert(!pico_vs_pos_rect("root", &pos, &btn3));
        pico_set_pencil_color("root", PICO_COLOR_GREEN);
        pico_output_draw_pixel("root", &(Pico_Rel_Pos){ 'w', {419, 392}, PICO_ANCHOR_C, NULL });
