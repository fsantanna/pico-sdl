...
int main(void) {
    ...
    puts("phy (500,500) -> log (50,50)");
    {
        ...
        pico_set_scene_dim(NULL, &(Pico_Rel_Dim){ '!', {50, 50}, NULL });
    ...
    puts("zoom out 2x");
    {
        pico_set_scene_src(NULL, (Pico_Rel_Rect){ '!', {-25, -25, 100, 100}, PICO_ANCHOR_NW, NULL });
    ...
    puts("zoom in 5x");
    {
        pico_set_scene_src(NULL, (Pico_Rel_Rect){ '!', {20, 20, 10, 10}, PICO_ANCHOR_NW, NULL });
    ...
    puts("scroll/zoom SE");
    {
        pico_set_scene_src(NULL, (Pico_Rel_Rect){ '!', {25, 25, 25, 25}, PICO_ANCHOR_NW, NULL });
    ...
    puts("normal PCT");
    {
        pico_set_scene_src(NULL, (Pico_Rel_Rect){ '!', {0, 0, 50, 50}, PICO_ANCHOR_NW, NULL });
