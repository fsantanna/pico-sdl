...
int main (void) {
    ...
    {
        puts("normal");
        pico_set_view_abs(-1, -1, &phy, NULL, NULL, NULL, NULL);
        pico_output_clear();
    ...
    }
    {
        ...
        pico_set_view_abs(-1, -1, &dim, NULL, NULL, NULL, NULL);
        pico_output_clear();
        pico_output_draw_rect_abs(r);
    ...
    {
        puts("normal");
        pico_set_view_abs(-1, 0, NULL, NULL, NULL, NULL, NULL);
        pico_output_clear();
        pico_output_draw_rect_abs(r);
    ...
    }
    {
        ...
        pico_set_view_abs(-1, -1, NULL, NULL, &dim, NULL, NULL);
        pico_output_clear();
