...
int main (void) {
    ...
    pico_set_layer("ui");
    pico_set_show_color(NULL, (Pico_Color){0x00, 0x00, 0x80, 0xFF});
    pico_output_clear();
    pico_set_draw_color(NULL, (Pico_Color){0x00, 0xFF, 0x00, 0xFF});
    pico_output_draw_rect(&(Pico_Rel_Rect){ '%', {0.5, 0.5, 0.5, 0.5}, PICO_ANCHOR_C, NULL });
    pico_set_layer(NULL);
    pico_output_clear();
    ...
    pico_set_show_color(NULL, (Pico_Color){0x00, 0x80, 0x00, 0xFF});
    pico_output_clear();
    pico_set_draw_color(NULL, (Pico_Color){0xFF, 0xFF, 0x00, 0xFF});
    pico_output_draw_rect(&(Pico_Rel_Rect){'%', {0.5, 0.5, 0.5, 0.5}, PICO_ANCHOR_C, NULL});
