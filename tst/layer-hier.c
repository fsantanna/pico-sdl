...
int main (void) {
    ...
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.3, 0.3, 0.4, 0.4}, PICO_ANCHOR_C, NULL});
    ...
    pico_set_layer("img");
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.7, 0.7, 0.4, 0.4}, PICO_ANCHOR_C, NULL});
    ...
    pico_set_layer("buf");
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.7, 0.3, 0.4, 0.4}, PICO_ANCHOR_C, NULL});
    ...
    pico_set_layer("txt");
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.3, 0.7, 0.4, 0.4}, PICO_ANCHOR_C, NULL});
    ...
    pico_set_layer("blue");
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.20, 0.9, 0.10, 0.10}, PICO_ANCHOR_C, NULL});

    pico_layer_sub("over", "green", "buf",
        &(Pico_Rel_Rect){'!', {1, 0, 1, 1}, PICO_ANCHOR_NW, NULL});
    pico_set_layer("green");
    pico_set_scene_dst(NULL, (Pico_Rel_Rect){'%', {0.40, 0.9, 0.10, 0.10}, PICO_ANCHOR_C, NULL});
