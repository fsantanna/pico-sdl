...
int main (void) {
...

    {
        ...
        pico_output_draw_pixmap("root", "buf1", (Pico_Abs_Dim){3,3}, pixmap, &r);
...

    {
        ...
        pico_output_draw_pixmap("root", "buf2", (Pico_Abs_Dim){9,1}, pixmap, &r);
    ...
    // 3x3 pixmap with w=6 → expect 6x6 render
    {
        ...
        pico_output_draw_pixmap("root", "buf3", (Pico_Abs_Dim){3,3}, pixmap, &r);
    ...
    // 3x3 pixmap → 6 wide × 3 tall (regression guard, x-stretch)
    {
        ...
        pico_output_draw_pixmap("root", "buf4", (Pico_Abs_Dim){3,3}, pixmap, &r);
