...
pico.layer.empty { mode='!', key="sheet", dim={'!', w=4, h=4} }
...
pico.layer.sub { mode='!', key="tl", sup="sheet",
    crop={'!', x=0, y=0, w=2, h=2, anchor='NW'} }
pico.layer.sub { mode='!', key="tr", sup="sheet",
    crop={'!', x=2, y=0, w=2, h=2, anchor='NW'} }
pico.layer.sub { mode='!', key="bl", sup="sheet",
    crop={'!', x=0, y=2, w=2, h=2, anchor='NW'} }
pico.layer.sub { mode='!', key="br", sup="sheet",
    crop={'!', x=2, y=2, w=2, h=2, anchor='NW'} }
...
pico.output.screenshot("window", "../../tst/out/sheet-grid.png")

local names = pico.layer.images {
    key="grid", path="../../tst/out/sheet-grid.png",
    sheet={'#', w=2, h=1},
}
assert(#names == 2)
...
local names2 = pico.layer.images {
    key="expl", path="../../tst/out/sheet-grid.png",
    sheet={
        '!',
