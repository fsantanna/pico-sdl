...
do
    ...
    pico.output.clear()
    pico.output.draw.rect('C', 0.5, 0.5, 0.5, 0.5)
    pico.check("pos-01")
end
...
do
    ...
    pico.output.clear()
    local r = {'NW', x=-0.1, y=-0.1, w=0.15, h=0.3}
    pico.set.color.draw(0xFF, 0xFF, 0xFF)
...
do
    ...
    pico.output.clear()
    local r = {'SE', x=1.1, y=1.1, w=0.15, h=0.3}
    pico.set.color.draw(0xFF, 0xFF, 0xFF)
    pico.output.draw.rect(r)
    pico.check("pos-05")
end
...
do
    ...
    local r1 = {'C', x=0.5, y=0.5, w=0.5, h=0.5}
    pico.set.color.draw(0xFF, 0xFF, 0xFF)
    pico.output.draw.rect(r1)

    print("red anchored by top-left under -10% of white")
    local r2 = {'NW', x=-0.1, y=-0.1, w=0.5, h=0.5, up=r1}
    pico.set.color.draw(0xFF, 0x00, 0x00)
    pico.output.draw.rect(r2)
...
do
    ...
    local r2 = {'SE', x=1.1, y=1.1, w=0.5, h=0.5, up=r1}
    pico.set.color.draw(0xFF, 0x00, 0x00)
    pico.output.draw.rect(r2)
