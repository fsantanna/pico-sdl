...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc='C'}
    pico.output.clear()
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc='NW'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc='SE'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc='E'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.2, y=0.2, w=0.4, h=0.4, anc={x=0.2,y=0.2}}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc={x=-0.25,y=-0.25}}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anc={x=1.25,y=1.25}}
    pico.output.clear()
    pico.output.draw.rect(r)
