...
local log = {'!', w=10, h=10}
pico.set.window { title="Anchoring..." }
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor='C'}
    pico.output.clear()
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor='NW'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor='SE'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor='E'}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.2, y=0.2, w=0.4, h=0.4, anchor={x=0.2,y=0.2}}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor={x=-0.25,y=-0.25}}
    pico.output.clear()
    pico.output.draw.rect(r)
...
do
    ...
    local r = {'%', x=0.5, y=0.5, w=0.4, h=0.4, anchor={x=1.25,y=1.25}}
    pico.output.clear()
    pico.output.draw.rect(r)
