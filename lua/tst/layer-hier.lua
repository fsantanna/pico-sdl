...
pico.set.scene { "L", target = {'%', x=0.3, y=0.3, w=0.4, h=0.4, anchor='C'},
    keep = true,
}
...
pico.set.scene { "img", target = {'%', x=0.7, y=0.7, w=0.4, h=0.4, anchor='C'},
}
...
pico.set.scene { "buf", target = {'%', x=0.7, y=0.3, w=0.4, h=0.4, anchor='C'},
}
...
pico.set.scene { "txt", target = {'%', x=0.3, y=0.7, w=0.4, h=0.4, anchor='C'},
}
...
pico.set.scene { "over", target = {'%', x=0.5, y=0.5, w=1, h=1, anchor='C'},
}
...
pico.set.scene { "blue", target = {'%', x=0.20, y=0.9, w=0.10, h=0.10, anchor='C'},
}

pico.layer.sub("over", "green", "buf",
    {'!', x=1, y=0, w=1, h=1, anchor='NW'})
pico.set.scene { "green", target = {'%', x=0.40, y=0.9, w=0.10, h=0.10, anchor='C'},
}
