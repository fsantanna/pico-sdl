...
do
    ...
    pico.set.view { grid=true, dim={'!', w=16, h=16} }
    pico.output.clear()
...
do
    ...
    pico.set.view { grid=true, dim={'#', w=8, h=8}, tile={w=2, h=2} }
    pico.output.clear()
...
do
    ...
    pico.set.view { grid=true, dim={'#', w=4, h=8}, tile={w=4, h=2} }
    pico.output.clear()
...
pico.set.view { grid=false, dim={'!', w=480, h=480} }
