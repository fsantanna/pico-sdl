...
do
    print("rect at 30%")
    pico.output.clear()
    local r1 = {x=30-25, y=30-25, w=50, h=50}
...
do
    ...
    local r2 = {x=r1.x+r1.w/2-12, y=r1.y+r1.h/2-12, w=25, h=25}
...
do
    ...
    local p3 = {x=r1.x+r1.w/2, y=r1.y+r1.h/2}
...
do
    ...
    local r4 = {x=r1.x+r1.w-12, y=r1.y+r1.h-12, w=25, h=25}
