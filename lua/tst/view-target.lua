...
do
    ...
    pico.set.scene { "bg", target = {'%', x=1, y=1, w=0.5, h=0.5, anchor='SE'}
    }
...
do
    ...
    pico.set.scene { "bg2", target = {'%', x=0.5, y=0.5, h=0.4}
    }
...
do
    ...
    pico.set.scene { "bg2", target = {'%', x=0.5, y=0.5, w=0.4, h=0}
    }
    pico.output.clear()
    pico.output.draw.layer("bg2")
...
do
    ...
    pico.set.scene { "bg2", target = {'%', x=0, y=0, w=0, anchor='NW'}
    }
    pico.output.clear()
    pico.output.draw.layer("bg2")
