...
print("zoom out 2x")
do
    pico.set.scene { source={'!', x=-25, y=-25, w=100, h=100} }
...
print("zoom in 5x")
do
    pico.set.scene { source={'!', x=20, y=20, w=10, h=10} }
...
do
    pico.set.scene { source={'!', x=25, y=25, w=25, h=25} }
...
print("normal PCT")
do
    pico.set.scene { source={'!', x=0, y=0, w=50, h=50} }
