...
// makes L the current layer and render target: point the renderer at
// L->tex and set the clip from L->scene.clip (the canonical target+clip
// dance); returns the previous layer for save/restore
